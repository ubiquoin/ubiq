...
#if defined(NDEBUG)
# error "Ubiquoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Ubiquoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    {
		nSubsidy = 50000000 * COIN;  // 500mil = 10 blocks x 50M
    } 
...
#ifdef ENABLE_WALLET
// Ubiquoin: attempt to generate suitable proof-of-stake
